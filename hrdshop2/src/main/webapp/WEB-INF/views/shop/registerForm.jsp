...
<section>
   <h1 align="center">회원가입 등록 페이지</h1>
   <form  id='reg_form' action='${pageContext.request.contextPath}/register' method='post'>
      <table>
         ...
         <tr>
            <td colspan=2>
            <input id='reg_button' type='button' value='가입' onclick='register()'>
            <input id='list_button' type='button' value='조회' onclick='list()'></td>
         </tr>
      </table>
   </form>
</section>
...
function register(){
  ...
  formObj.url="${pageContext.request.contextPath}/register";
  formObj.method='post';
  formObj.submit();
}
</script>
